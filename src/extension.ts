...
const PIXI_VN_UNIMPLEMENTED_FUNCTIONS = new Set([
    "CHOICE_COUNT",
    "TURNS",
    "TURNS_SINCE",
    "SEED_RANDOM",
...
const PIXI_VN_NOT_IMPLEMENTED_WARNING =
    "\n\n---\n\n⚠️ **Not yet implemented in the `pixi-vn` engine.** If you need this function, please [contact the developers](https://github.com/DRincs-Productions/pixi-vn-ink-vscode/issues) to request it.";
