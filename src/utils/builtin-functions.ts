...
export const BUILTIN_FUNCTIONS: Record<string, string> = {
    ...
    TURNS: l10n.t("**TURNS()**: Returns the number of game turns (player choices) since the story began."),
    TURNS_SINCE: l10n.t(
    ...
    RANDOM: l10n.t(
        "**RANDOM(min, max)**: Returns a random integer between `min` and `max`, inclusive (like rolling a dice).\n\nExample:\n```ink\n~ temp dice_roll = RANDOM(1, 6)\n```",
    ),
    INT: l10n.t(
        "**INT(x)**: Casts `x` to an integer, truncating towards zero.\n\nExample:\n```ink\n{INT(3.2)} is 3.\n{INT(-4.8)} is -4.\n```",
    ),
    FLOOR: l10n.t(
        "**FLOOR(x)**: Casts `x` to an integer, rounding down.\n\nExample:\n```ink\n{FLOOR(4.8)} is 4.\n{FLOOR(-4.8)} is -5.\n```",
    ),
    FLOAT: l10n.t("**FLOAT(x)**: Casts `x` to a floating point number.\n\nExample:\n```ink\n{FLOAT(4)} is, um, still 4.\n```"),
    POW: l10n.t(
